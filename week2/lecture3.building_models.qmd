...
load(here("week2/data/sierraczosolar.rda"))
...
head(str(site2))
# this is pretty messy - but we can extract a useful data structure, let's say we want
...
*To explore on our own, vary efficiency in different ways! Read*
